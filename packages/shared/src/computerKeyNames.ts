 ...
 * cannot import it, so the macOS backend ships a coverage test beside its
 * helper that reads the Swift source and checks it against this list, rather
 * than a comment asking someone to remember; that test travels with the macOS
 * backend, not with this module.
 *
