...
/**
 * Every provider runtime leases the same capability set, `computer:control`
 * included — see `AgentGatewaySessionRegistry`. A lease therefore takes no
 * capability input: there is no session-start fact left that can widen or
