...
import Migration0088 from "./Migrations/088_MobileAuthAudienceAndPairingDigests.ts";
import Migration0089 from "./Migrations/089_ThreadCreationOperations.ts";
...
export const migrationEntries = [
  ...
  [88, "MobileAuthAudienceAndPairingDigests", Migration0088],
  [89, "ThreadCreationOperations", Migration0089],
] as const;
