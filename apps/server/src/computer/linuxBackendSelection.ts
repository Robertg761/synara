 ...
 * Hyprland plugin on a live Hyprland session, the KWin plugin on a KWin
 * Wayland session, and the headless nested compositor for every other desktop. Every host gets a tier, so this never answers
